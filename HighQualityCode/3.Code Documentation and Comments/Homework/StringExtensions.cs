...
namespace Telerik.ILS.Common
{
    ...
    /// <summary>
    /// Extension method for working with string
    /// </summary>
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Convert string to short type if is possible.
        /// </summary>
        /// <param name="input">value of string type to converting</param>
        /// <returns>if can be converted return short variable else return default value of short</returns>
        ...
        /// <summary>
        /// Convert string to integer type if is possible.
        /// </summary>
        /// <param name="input">value of string type to converting</param>
        /// <returns>if can be converted return integer variable else return default value of integer</returns>
        ...
        /// <summary>
        /// Convert string to long type if is possible.
        /// </summary>
        /// <param name="input">value of string type to converting</param>
        /// <returns>if can be converted return long variable else return default value of long</returns>
        ...
        /// <summary>
        /// Gets the file extension of a file name of a string
        /// </summary>
